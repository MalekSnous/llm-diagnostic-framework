...
class RAGSystem(BaseImprovementStrategy):
    ...
    def __init__(self):
        super().__init__(
            name="RAG System",
            description="Augment LLM with retrieval from knowledge base"
        )
    ...
    def get_implementation_guide(self) -> str:
        """Return implementation guide for RAG strategy."""
        return """
        RAG (Retrieval-Augmented Generation) Strategy:
        1. Index knowledge base using embeddings
        ...
        **kwargs
        ...
        for test_case in test_cases:
            ...
            success = (
                ...
                if test_case.expected_output else True
            )
        ...
        total_cost = sum(
            r.response.cost_usd for r in improved_results
        ...
        result = ImprovementResult(
            ...
            metadata={
                "num_documents_indexed": self.collection.count() if self.collection else 0
            }
        )
